...
public class PrintPreview   extends JInternalFrame{
    ...
    private void replaceContainer(Container from, Container to) {
        ...
        //to.setExtendedState(to.MAXIMIZED_BOTH);
    ...
    public PrintPreview() {
        ...
        JButton btn_PrintComponet,btn_ZoomIn,btn_ZoomOut,btn_Close;
        btn_PrintComponet=new JButton(new ImageIcon("icons/print.png"));
        btn_ZoomIn=new JButton(new ImageIcon("icons/zoom_in.png"));
        btn_ZoomOut=new JButton(new ImageIcon("icons/zoom_out.png"));
        btn_Close=new JButton(new ImageIcon("icons/c_close.png"));
        toolBar.add(btn_PrintComponet);
        btn_PrintComponet.addActionListener(printComponent);
        toolBar.add(btn_ZoomIn);
        btn_ZoomIn.addActionListener(zoomIn);
        toolBar.add(btn_ZoomOut);
        btn_ZoomOut.addActionListener(zoomOut);
        toolBar.add(btn_Close);
        btn_Close.addActionListener(closePreview);
        ...
        previewHost.add(toolBar,BorderLayout.NORTH);
       //previewHost.setJMenuBar(menuBar);
        
        previewHost.add(new JScrollPane(previewPane));
        previewHost.setSize(800, 600);
        previewHost.setResizable(false);
        //previewHost.setExtendedState(previewHost.MAXIMIZED_BOTH);
    }
}